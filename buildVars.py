...
addon_info = {
	...
	"addon_name": "EnhanceTools",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Enhance Tools"),
	# Add-on description
...
* Anuncio de carpeta vacía en explorador de windows."""),
	...
	"addon_url": "https://github.com/hxebolax/EnhanceTools",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/hxebolax/EnhanceTools",
...
pythonSources = ["addon/globalPlugins/EnhanceTools.py"]
